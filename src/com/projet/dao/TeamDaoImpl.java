...
public class TeamDaoImpl implements TeamDao {
    ...
    private static final String SQL_SELECT        = "SELECT id, id_pilote, nomTeam, motTeam, siegeS, directeur FROM Team ORDER BY id";
    private static final String SQL_SELECT_PAR_ID = "SELECT id, id_pilote, nomTeam, motTeam, siegeS, directeur FROM Team  WHERE id = ?";
    private static final String SQL_INSERT        = "INSERT INTO Team (id_pilote, date, id, nomTeam, motTeam, siegeS, directeur) VALUES (?, ?, ?, ?, ?, ?, ?)";
    private static final String SQL_DELETE_PAR_ID = "DELETE FROM Team WHERE id = ?";
    ...
    @Override
    public Team trouver( long id ) throws DAOException {
        return trouver( SQL_SELECT_PAR_ID, id );
    }

    /* Implémentation de la méthode définie dans l'interface CommandeDao */
    @Override
    public void creer( Team team ) throws DAOException {
        ...
        try {
            ...
            preparedStatement = initialisationRequetePreparee( connexion, SQL_INSERT, true,
                    team.getPilote().getId(), new Timestamp( team.getDate().getMillis() ),
                    team.getNomTeam(),
                    team.getMotTeam(),
                    team.getDirecteur() );
            ...
            if ( valeursAutoGenerees.next() ) {
                team.setId( valeursAutoGenerees.getLong( 1 ) );
            } else {
    ...
    @Override
    public List<Team> lister() throws DAOException {
