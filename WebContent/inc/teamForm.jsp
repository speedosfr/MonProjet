...
<div class="lolo col-lg-6 ">
	...
	<div class="form-group">
		<div class="row">
			...
			<label for="nomTeam">Nom de l'équipe </label> <input type="text"
				id="nomTeam" class="form-control col-lg-2" name="nomTeam"
				value="<c:out value="${team.nomTeam}"/>" size="20" maxlength="20" />
		</div>
	...
	<div class="form-group">
		<div class="row">
			<label for="motorTeam">Motoriste </label> <input type="text"
				id="motTeam" class="form-control col-lg-2" name="motTeam"
				value="<c:out value="${team.motTeam}"/>" size="20" maxlength="20" />
		</div>
	...
	<div class="form-group">
		<div class="row">
			<label for="siegeS">Siege social </span>
				...
				name="siegeS" value="<c:out value="${team.siegeS}"/>" size="20"
				maxlength="20" />
		</div>
	...
	<div class="form-group">
		<div class="row">
			<label for="directeur">Directeur </span>
				...
				name="directeur" value="<c:out value="${team.directeur}"/>"
